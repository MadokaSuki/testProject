...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        accuracy_str = str(round(self.stats.shoot_accuracy, 2)) + "%"
        ...
        self.accuracy_rect.right = self.score_rect.right
    ...
    def show_score(self):
        ...
        self.ships.draw(self.screen)  # 先draw后blit

    def prep_high_score(self):
        high_score = "{:,}".format(round(self.stats.high_score, -1))
    ...
    def prep_level(self):
        ...
        self.level_rect.top = self.accuracy_rect.bottom + 10
